        ...
        try {
            while (true) {
                ...
                if(w!=null && w.startsWith("/w")){
                 String[] addressee_arr = w.split("/w ");
                 String temp = w.substring(3);
                 String[] addressee_arr1 = temp.split(" ");
                 String addressee = addressee_arr1[0];
                 String message = w.substring(4+addressee.length());
                 owner.privateMsg(name + ": " + message, addressee, this);
