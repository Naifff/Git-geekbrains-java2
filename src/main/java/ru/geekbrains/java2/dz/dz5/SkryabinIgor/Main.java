package ru.geekbrains.java2.dz.dz5.SkryabinIgor;
...
public class Main {
    ...
    public void runOneThread() {
        ...
        calculate(arr);
        System.out.println("Первый метод  заканчивается: " + (System.currentTimeMillis() - a));
    }
    ...
    public void runTwoThreads() {
        ...
        System.out.println("Второй метод заканчивается: " + (System.currentTimeMillis() - a));
    }
